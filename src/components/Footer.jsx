...
function SocialLink({ href, label, children }) {
  ...
  if (isEmpty) {
    return (
      <span className="footer-social-icon footer-social-icon--disabled" aria-label={label} title={label}>
        {children}
      </span>
    )
  }
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label={label}>
      {children}
    </a>
  )
}
    ...
    <footer className="site-footer">
      <div className="footer-inner">
        <div className="footer-brand">
          ...
          <p>{siteConfig.contactName} · {siteConfig.contactTitle}</p>
